...
impl Token {
    pub fn begin_highlight(&self) -> &'static str {
        match self.kind {
            ...
            TokenKind::Keyword(_) => "\x1b[34m",                // Blue
            TokenKind::Identifier => "\x1b[32m",                // Green
            TokenKind::SingleQuotedStringLiteral => "\x1b[35m", // Magenta
            TokenKind::DoubleQuotedStringLiteral => "\x1b[35m", // Magenta
            TokenKind::IntegerLiteral => "\x1b[36m",            // Cyan
            TokenKind::DecimalLiteral => "\x1b[36m",            // Cyan
            TokenKind::HexadecimalLiteral => "\x1b[36m",        // Cyan
            TokenKind::ExponentLiteral => "\x1b[36m",           // Cyan
